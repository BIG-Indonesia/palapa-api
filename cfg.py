...
GEOSERVER_WMS_OUT = 'http://REPGSMANAGERDOMOUT/geoserver/wms?'
GEOSERVER_WFS_OUT = 'http://REPGSMANAGERDOMOUT/geoserver/wms?'
GEOSERVER_USER = 'syspalapa'
GEOSERVER_PASS = 'sysp4l4p4'
...
DATASTORE_DB = 'palapa'
UPLOAD_FOLDER = '/var/palapa/uploads/'
RASTER_FOLDER = '/var/palapa/data/'
RASTER_STORE = '/var/palapa/data/'
DOCUMENTS_FOLDER = '/var/palapa/documents/'
DOWNLOADS_FOLDER = '/var/palapa/downloads/'
ALLOWED_EXTENSIONS = set(['zip', 'ZIP','shp', 'SHP','shx', 'SHX','dbf', 'DBF','prj', 'PRJ'])
